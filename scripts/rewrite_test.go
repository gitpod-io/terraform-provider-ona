...
`,
			Inventory: inventory{
				Resources: []inventoryResource{
					{Type: "ona_runner_environment_class", Address: "ona_runner_environment_class.frankfurt_large", UUID: "class-1"},
					{Type: "ona_runner_environment_class", Address: "ona_runner_environment_class.gcp_large", UUID: "class-2"},
					{Type: "ona_runner_environment_class", Address: "ona_runner_environment_class.virginia_large", UUID: "class-3"},
				},
			},
			Expected: Expectation{
  ...
  prebuild_configuration {
    environment_class_ids = [
      ona_runner_environment_class.frankfurt_large.id,
      ona_runner_environment_class.gcp_large.id,
      ona_runner_environment_class.virginia_large.id,
    ]
  }
}
`,
...
`,
			...
			Expected: Expectation{
				Result: `resource "ona_project" "next" {
  environment_classes {
    id        = ona_runner_environment_class.frankfurt_large.id
    order     = 0
    prebuilds = true
  }
}
