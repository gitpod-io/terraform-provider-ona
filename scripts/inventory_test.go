				...
				Result: []inventoryResource{
					{
						...
						Address:  "ona_environment_class.frankfurt_large",
						UUID:     "class-1",
						ImportID: "class-1",
						Name:     "Large",
					...
					{
						Type:     "ona_environment_class",
						Address:  "ona_environment_class.us_east_large",
						UUID:     "class-2",
						ImportID: "class-2",
						Name:     "Large",
						References: map[string]string{
...
func TestMergeExternalResourcesUpgradesLegacyEnvironmentClasses(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			External: []inventoryResource{
				{Type: "ona_environment_class", Address: "ona_environment_class.frankfurt_large", UUID: "class-1", ImportID: "class-1"},
				{Type: "ona_environment_class", Address: "ona_environment_class.frankfurt_regular", UUID: "class-2", ImportID: "class-2"},
			},
			Expected: Expectation{
				Result: []inventoryResource{
					{Type: "ona_project", Address: "ona_project.next", UUID: "project-1", ImportID: "project-1"},
