...
and keeps a copied generated public API client under `internal/api/go` so the
...
- `internal/api/go/**`: copied generated public API client. Do not hand-edit for lint-only or style changes.
