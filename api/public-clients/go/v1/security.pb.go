...
type SecurityPolicy_Spec_PortPolicy struct {
	...
	MaxAdmissionLevel AdmissionLevel `protobuf:"varint,3,opt,name=max_admission_level,json=maxAdmissionLevel,proto3,enum=gitpod.v1.AdmissionLevel" json:"max_admission_level,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *SecurityPolicy_Spec_PortPolicy) GetMaxAdmissionLevel() AdmissionLevel {
	if x != nil {
		return x.MaxAdmissionLevel
	}
...
const file_gitpod_v1_security_proto_rawDesc = "" +
	...
	"\x14DeleteSecurityPolicy\x12&.gitpod.v1.DeleteSecurityPolicyRequest\x1a'.gitpod.v1.DeleteSecurityPolicyResponse\"\x00B'Z%github.com/gitpod-io/gitpod-sdk-go/v1b\x06proto3"
...
var file_gitpod_v1_security_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_gitpod_v1_security_proto_goTypes = []any{
	...
	(*SecurityPolicy_Spec_PortPolicy)(nil),            // 15: gitpod.v1.SecurityPolicy.Spec.PortPolicy
	(*SecurityPolicy_Spec_ExecutablePolicy)(nil),      // 16: gitpod.v1.SecurityPolicy.Spec.ExecutablePolicy
	(*SecurityPolicy_Spec_ExecutablePolicy_Rule)(nil), // 17: gitpod.v1.SecurityPolicy.Spec.ExecutablePolicy.Rule
	(*PaginationRequest)(nil),                         // 18: gitpod.v1.PaginationRequest
	(*PaginationResponse)(nil),                        // 19: gitpod.v1.PaginationResponse
	(*timestamppb.Timestamp)(nil),                     // 20: google.protobuf.Timestamp
	(AdmissionLevel)(0),                               // 21: gitpod.v1.AdmissionLevel
}
var file_gitpod_v1_security_proto_depIdxs = []int32{
	...
	18, // 4: gitpod.v1.ListSecurityPoliciesRequest.pagination:type_name -> gitpod.v1.PaginationRequest
	12, // 5: gitpod.v1.ListSecurityPoliciesRequest.filter:type_name -> gitpod.v1.ListSecurityPoliciesRequest.Filter
	19, // 6: gitpod.v1.ListSecurityPoliciesResponse.pagination:type_name -> gitpod.v1.PaginationResponse
	...
	20, // 13: gitpod.v1.SecurityPolicy.created_at:type_name -> google.protobuf.Timestamp
	20, // 14: gitpod.v1.SecurityPolicy.updated_at:type_name -> google.protobuf.Timestamp
	15, // 15: gitpod.v1.SecurityPolicy.Spec.ports:type_name -> gitpod.v1.SecurityPolicy.Spec.PortPolicy
	16, // 16: gitpod.v1.SecurityPolicy.Spec.executables:type_name -> gitpod.v1.SecurityPolicy.Spec.ExecutablePolicy
	21, // 17: gitpod.v1.SecurityPolicy.Spec.PortPolicy.max_admission_level:type_name -> gitpod.v1.AdmissionLevel
	0,  // 18: gitpod.v1.SecurityPolicy.Spec.ExecutablePolicy.default_effect:type_name -> gitpod.v1.SecurityPolicy.Effect
	17, // 19: gitpod.v1.SecurityPolicy.Spec.ExecutablePolicy.rules:type_name -> gitpod.v1.SecurityPolicy.Spec.ExecutablePolicy.Rule
	0,  // 20: gitpod.v1.SecurityPolicy.Spec.ExecutablePolicy.Rule.effect:type_name -> gitpod.v1.SecurityPolicy.Effect
	1,  // 21: gitpod.v1.SecurityService.CreateSecurityPolicy:input_type -> gitpod.v1.CreateSecurityPolicyRequest
	3,  // 22: gitpod.v1.SecurityService.GetSecurityPolicy:input_type -> gitpod.v1.GetSecurityPolicyRequest
	5,  // 23: gitpod.v1.SecurityService.ListSecurityPolicies:input_type -> gitpod.v1.ListSecurityPoliciesRequest
	7,  // 24: gitpod.v1.SecurityService.UpdateSecurityPolicy:input_type -> gitpod.v1.UpdateSecurityPolicyRequest
	9,  // 25: gitpod.v1.SecurityService.DeleteSecurityPolicy:input_type -> gitpod.v1.DeleteSecurityPolicyRequest
	2,  // 26: gitpod.v1.SecurityService.CreateSecurityPolicy:output_type -> gitpod.v1.CreateSecurityPolicyResponse
	4,  // 27: gitpod.v1.SecurityService.GetSecurityPolicy:output_type -> gitpod.v1.GetSecurityPolicyResponse
	6,  // 28: gitpod.v1.SecurityService.ListSecurityPolicies:output_type -> gitpod.v1.ListSecurityPoliciesResponse
	8,  // 29: gitpod.v1.SecurityService.UpdateSecurityPolicy:output_type -> gitpod.v1.UpdateSecurityPolicyResponse
	10, // 30: gitpod.v1.SecurityService.DeleteSecurityPolicy:output_type -> gitpod.v1.DeleteSecurityPolicyResponse
