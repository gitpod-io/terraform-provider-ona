...
// go test -benchmem -run='^$' -bench '^(BenchmarkResourceCache_Get|BenchmarkResourceCache_List|BenchmarkResourceCache_FullSync|BenchmarkResourceCache_Concurrent|BenchmarkWithBudgets)$' github.com/gitpod-io/terraform-provider-ona/api/public-clients/go/client/cache
