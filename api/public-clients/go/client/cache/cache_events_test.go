...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -package cache_test -destination cache_mock_test.go github.com/gitpod-io/terraform-provider-ona/api/public-clients/go/client/cache Invalidator,EventStream
