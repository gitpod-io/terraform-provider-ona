...
func securityPolicySpecFromModel(_ context.Context, model *SpecModel, root path.Path) (*v1.SecurityPolicy_Spec, diag.Diagnostics) {
	var diags diag.Diagnostics
	if model == nil {
...
func preserveSpecPlannedInputs(_, _ *SpecModel) {}
