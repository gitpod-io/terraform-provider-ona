		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.ona_runner.test", "configuration.metrics.enabled", "true"),
					resource.TestCheckResourceAttr("data.ona_runner.test", "configuration.metrics.url", "https://metrics.example.com/api/v1/write"),
					resource.TestCheckResourceAttr("data.ona_runner.test", "configuration.metrics.username", "runner"),
					resource.TestCheckResourceAttr("data.ona_runner.test", "configuration.metrics.managed_metrics_enabled", "false"),
					resource.TestCheckNoResourceAttr("data.ona_runner.test", "configuration.metrics.password"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.ona_runners.test", "runners.0.configuration.metrics.enabled", "true"),
					resource.TestCheckNoResourceAttr("data.ona_runners.test", "runners.0.configuration.metrics.password"),
