...
const (
	agentCodex   = "codex"
	agentOna     = "ona"
	codexAgentID = "00000000-0000-0000-0000-000000007800"
	onaAgentID   = "00000000-0000-0000-0000-000000007100"
)
...
var (
	agentValues      = []string{agentOna, agentCodex}
...
func agentFromID(agentID string) (string, bool) {
	switch agentID {
	case "", codexAgentID:
		return agentCodex, true
	case onaAgentID:
		return agentOna, true
	default:
		return "", false
	}
}
...
func codexReasoningEffortToString(value v1.CodexReasoningEffort) (string, bool) {
	...
	case v1.CodexReasoningEffort_CODEX_REASONING_EFFORT_EXTRA_HIGH:
		return "xhigh", true
	case v1.CodexReasoningEffort_CODEX_REASONING_EFFORT_MAX:
		return "max", true
	case v1.CodexReasoningEffort_CODEX_REASONING_EFFORT_ULTRA:
		return "ultra", true
	default:
		return "", false
	}
