...
func TestUpdateWorkflowRequestCodexSettings(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			Expected: Expectation{Settings: &v1.CodexSettings{ReasoningEffort: v1.CodexReasoningEffort_CODEX_REASONING_EFFORT_EXTRA_HIGH}},
		},
	}
...
func TestCodexModelMapping(t *testing.T) {
	...
	tests := []struct {
		...
		{Name: "gpt_5_5", Local: "gpt-5.5", Remote: v1.CodexOpenAIModel_CODEX_OPEN_AI_MODEL_GPT_5_5, Expected: Expectation{Remote: v1.CodexOpenAIModel_CODEX_OPEN_AI_MODEL_GPT_5_5, Local: "gpt-5.5", OK: true}},
		{Name: "gpt_5_4", Local: "gpt-5.4", Remote: v1.CodexOpenAIModel_CODEX_OPEN_AI_MODEL_GPT_5_4, Expected: Expectation{Remote: v1.CodexOpenAIModel_CODEX_OPEN_AI_MODEL_GPT_5_4, Local: "gpt-5.4", OK: true}},
		{Name: "gpt_5_3_codex", Local: "gpt-5.3-codex", Remote: codexOpenAIModelGPT53Codex, Expected: Expectation{Remote: codexOpenAIModelGPT53Codex, Local: "gpt-5.3-codex", OK: true}},
		{Name: "gpt_5_3_codex_spark", Local: "gpt-5.3-codex-spark", Remote: codexOpenAIModelGPT53CodexSpark, Expected: Expectation{Remote: codexOpenAIModelGPT53CodexSpark, Local: "gpt-5.3-codex-spark", OK: true}},
		{Name: "gpt_5_2", Local: "gpt-5.2", Remote: codexOpenAIModelGPT52, Expected: Expectation{Remote: codexOpenAIModelGPT52, Local: "gpt-5.2", OK: true}},
		{Name: "gpt_5_6_sol", Local: "gpt-5.6-sol", Remote: v1.CodexOpenAIModel_CODEX_OPEN_AI_MODEL_GPT_5_6_SOL, Expected: Expectation{Remote: v1.CodexOpenAIModel_CODEX_OPEN_AI_MODEL_GPT_5_6_SOL, Local: "gpt-5.6-sol", OK: true}},
		{Name: "gpt_5_6_terra", Local: "gpt-5.6-terra", Remote: v1.CodexOpenAIModel_CODEX_OPEN_AI_MODEL_GPT_5_6_TERRA, Expected: Expectation{Remote: v1.CodexOpenAIModel_CODEX_OPEN_AI_MODEL_GPT_5_6_TERRA, Local: "gpt-5.6-terra", OK: true}},
		{Name: "gpt_5_6_luna", Local: "gpt-5.6-luna", Remote: v1.CodexOpenAIModel_CODEX_OPEN_AI_MODEL_GPT_5_6_LUNA, Expected: Expectation{Remote: v1.CodexOpenAIModel_CODEX_OPEN_AI_MODEL_GPT_5_6_LUNA, Local: "gpt-5.6-luna", OK: true}},
		{Name: "mini_canonicalizes_on_read", Local: "gpt-5.4-mini", Remote: codexOpenAIModelGPT54Mini, Expected: Expectation{Local: "gpt-5.4"}},
	...
	for _, tc := range tests {
		t.Run(tc.Name, func(t *testing.T) {
			...
			if tc.Name == "mini_canonicalizes_on_read" {
				got.Remote = v1.CodexOpenAIModel_CODEX_OPEN_AI_MODEL_UNSPECIFIED
				got.OK = fromOK
			}
...
func TestCodexReasoningEffortMapping(t *testing.T) {
	...
	tests := []struct {
		...
		{Name: "low", Local: "low", Remote: v1.CodexReasoningEffort_CODEX_REASONING_EFFORT_LOW, Expected: Expectation{Remote: v1.CodexReasoningEffort_CODEX_REASONING_EFFORT_LOW, Local: "low", OK: true}},
		{Name: "medium", Local: "medium", Remote: v1.CodexReasoningEffort_CODEX_REASONING_EFFORT_MEDIUM, Expected: Expectation{Remote: v1.CodexReasoningEffort_CODEX_REASONING_EFFORT_MEDIUM, Local: "medium", OK: true}},
		{Name: "high", Local: "high", Remote: v1.CodexReasoningEffort_CODEX_REASONING_EFFORT_HIGH, Expected: Expectation{Remote: v1.CodexReasoningEffort_CODEX_REASONING_EFFORT_HIGH, Local: "high", OK: true}},
		{Name: "xhigh", Local: "xhigh", Remote: v1.CodexReasoningEffort_CODEX_REASONING_EFFORT_EXTRA_HIGH, Expected: Expectation{Remote: v1.CodexReasoningEffort_CODEX_REASONING_EFFORT_EXTRA_HIGH, Local: "xhigh", OK: true}},
...
func TestWorkflowUsesCodex(t *testing.T) {
	...
	tests := []struct {
		...
		{Name: "unpinned", Workflow: &v1.Workflow{Spec: &v1.Workflow_Spec{}}},
