...
func (r *Resource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
	...
	validateResolvedDefinitionBackedConfig(plan, config, &resp.Diagnostics)
...
func (r *Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	validateResolvedDefinitionBackedConfig(data, config, &resp.Diagnostics)
	if resp.Diagnostics.HasError() {
		return
	}
	if !providerdata.RequireResourceClient(r.client, &resp.Diagnostics, "creating", "ona_integration") {
		return
	}
...
func (r *Resource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	if !providerdata.RequireResourceClient(r.client, &resp.Diagnostics, "reading", "ona_integration") {
		return
	}
	if !tfvalue.IsKnownString(data.ID) {
...
func (r *Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if !providerdata.RequireResourceClient(r.client, &resp.Diagnostics, "updating", "ona_integration") {
		return
	}
...
func (r *Resource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if !providerdata.RequireResourceClient(r.client, &resp.Diagnostics, "deleting", "ona_integration") {
		return
	}
	if !tfvalue.IsKnownString(data.ID) {
		resp.State.RemoveResource(ctx)
